        ...
        <Layout>
            <div className="content-light">
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group">
                        <input name="username" placeholder="Username" type="email" {...register('username')} className={`form-control ${errors.username ? 'is-invalid' : ''}`} />
                    ...
                    <Link href="/account/login" className="btn btn-danger ml-1">Cancel</Link>
                </form>
            </div>
        </Layout>
    );
